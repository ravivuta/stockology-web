...
type State = {
  ...
  setSettings: (p: Partial<Pick<State, "riskAppetite" | "enableRiskFilter" | "limitWatchlistSize" | "etfProfitTarget" | "stockProfitTarget" | "timezone" | "region">>) => void;
...
function recalcHolding(
  s: StockHolding,
  ctx: { etfProfitTarget: number; stockProfitTarget: number }
): StockHolding {
    ...
    (set, get) => ({
      ...
      updateStock: (symbol, patch) =>
        set((st) => {
          ...
          const ctx = { etfProfitTarget: st.etfProfitTarget, stockProfitTarget: st.stockProfitTarget };
      ...
      undoLastTrade: () => {
        ...
        set((s) => {
          const ctx = { etfProfitTarget: s.etfProfitTarget, stockProfitTarget: s.stockProfitTarget };
